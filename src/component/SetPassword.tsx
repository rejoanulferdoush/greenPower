...
export default function SetPassword({ onBack, onResetPassword }: SetPasswordProps) {
            ...
            <div className="mb-5 flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="h-12 w-full rounded-[0.625rem] border border-[#d1d5db] pl-4 pr-12 text-[0.875rem] text-[#1c1c1c] placeholder:text-[#9ca3af] focus:outline-none focus:ring-2 focus:ring-[#1d6ef5]/30"
                />
                <button
                  type="button"
